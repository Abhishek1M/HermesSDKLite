...
//        finalbyte[0] = (byte) ((x >>> 0) & 0xff);
//
//        System.out.println(x >>> 8);
//        System.out.println(x >>> 0);
//        System.out.println(Integer.toBinaryString(x));
//        System.out.println(FormatData.hexdump(finalbyte));
//        System.out.println(hexdump(hex2byte("123456")));
//        System.out.println(protect("4216210000000023"));
//        System.out.println(protect("4216210000000023=13121262345678"));
//        
//        
//        
//        System.out.println(Double.parseDouble("10.000Y"));
//    }
}
