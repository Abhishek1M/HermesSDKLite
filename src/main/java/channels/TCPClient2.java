...
public class TCPClient2
{
     ...
     */
    public TCPClient2(INonBlockingConnection inbcx)
    {
        this.inbcx = inbcx;
    }
     ...
     */
    public TCPClient2(String name, AppQueue event_q, String remoteaddress, int port,
 ...
 /*
    ...
    public boolean reconnect(long timer)
    {
        ...
        {
            Logger.getLogger(TCPClient2.class.getName()).
            ...
            IIdleTimeoutHandler, IConnectExceptionHandler
    {
        ...
        public boolean onData(INonBlockingConnection inbc) throws IOException
        {
            try
            {
                ...
                int utflen = Utility.validateSufficientDatasizeByShortLengthFieldBinary(inbc);
