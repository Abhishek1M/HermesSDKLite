...
public class TCPServerDL2
{
     ...
     */
    public TCPServerDL2(String name, String ipaddress, int port, AppQueue event_q,
...
//                    backlog);
    ...
    {
        data = Translate.fromHexToBin("02") + data + Translate.
                fromHexToBin("03");
            ...
            IDisconnectHandler, IConnectionTimeoutHandler, IIdleTimeoutHandler
    {
                ...
                MaxReadSizeExceededException
        {
            ...
            parseddata = inbc.readBytesByDelimiter(Translate.fromHexToBin("03"));
            newparseddata = new byte[parseddata.length-1];
            System.arraycopy(parseddata, 1, newparseddata, 0, parseddata.length-1);

            event_q.add(new DataEvent(newparseddata, inbc, getName()));
            inbcx = inbc;
