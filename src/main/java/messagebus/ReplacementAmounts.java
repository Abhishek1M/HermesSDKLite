...
public class ReplacementAmounts
{
     ...
     */
    /*
     * public static void main(String[] args) { //ReplacementAmounts RA = new
     * ReplacementAmounts("000000120000000000000000D00000000D00000000");
     * ReplacementAmounts RA = new
     * ReplacementAmounts("100000","0","D00000000","D00000000");
     *
     * System.out.println(RA.getActual_tran_amount());
     * System.out.println(RA.getActual_stl_amount());
     * System.out.println(RA.getActual_tran_amount_fee());
     * System.out.println(RA.getActual_stl_amount_fee());
     *
     * System.out.println(RA.getReplacementAmt()); }
     *
     */
}
